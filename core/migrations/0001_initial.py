# Generated by Django 3.0.7 on 2020-09-14 17:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dateConfirmation', models.DateField(default=datetime.date.today, verbose_name='Data de Confirmação')),
                ('dateConcession', models.DateField(default=datetime.date.today, verbose_name='Data de concessão')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sources', models.TextField(verbose_name='Fonte')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occupation', models.TextField(default='NA', verbose_name='Ocupação')),
                ...
                ('comments', models.TextField()),
                ('privileged_observations', models.TextField()),
                ('captaincy_resident_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Capitania', to='core.Captaincy')),
            ],
        ),
        migrations.CreateModel(
            name='ReligiousOrder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reference', models.CharField(blank=True, default='', max_length=10, null=True, unique=True, verbose_name='Referência')),
                ('oldReference', models.CharField(default='', max_length=10, unique=True, verbose_name='Referência da SILB antiga')),
